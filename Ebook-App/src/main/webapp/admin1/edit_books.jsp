						...
						<form action="../edit_books" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input name="price" type="number" class="form-control"
									id="exampleInputpassword1" aria-describedby="emailHelp" value="<%=b.getPrice()%>">
							</div>
							
							<div class="form-group">
								<lable for="inputstate">Book Status</lable>
								<select id="inptstate" name="bstatus" class="form-control">
